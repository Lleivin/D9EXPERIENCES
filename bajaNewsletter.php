...
<div id="mensajePrueba">
      ...
      <section class="sectionLogin sectionLogin" >
              ...
              <div class="cajanewsLetter margenBajaNewsletter">
                ...
                <form id="formularioBajaNewsletter" class="formularioNewsletter" action="" method="POST">
                  <div class="cajaDatosNewsletter mt-3">
                    <input class="datosNewsletter correoNews d-flex col-8" type="email" id="emailBajaNewsletter" name="emailBajaNewsletter" placeholder=" Correo@ejemplo.com">
                    <input class="datosNewsletter enviarNewsletter d-flex col-4" name="bajaNewslatter" type="submit"  value="Dar de Baja">
                  </div>
                </form>

                <div id="cajaMensajeErrorBajaNewsletter">
                </div>
