...
?>
    ...
    <main>
      ...
      <div class="cajaLogin" id="cajaNuevaPartida">
        ...
        <form id="formCrearPartida" class="formLogin" action="" method="POST">
            <h4 class="d-flex m-auto col-12 col-sm-12">Crear nueva Partida</h4>
            ...
            <select id="campoJuego" class="selecciones " name="idCampo" >
                ...
                if ($todosCampos->num_rows > 0) {
                  while ($campo = $todosCampos->fetch_assoc()) {
                      echo '<option value="' . htmlspecialchars($campo['idCampo']) . '">'
          ...
          <div class="cajaformulario">
           ...
           placeholder="Nº máximo de jugadores" step="1">
          </div>

          <div class="cajaformulario d-flex col-10">
              <label for="portadaPartida">Portada</label>
              <input id="portadaPartida" class="usuario" type="url" name="portadaPartida"
                    placeholder="Pega aquí la URL">
          </div>

          <div class="cajaformulario d-flex col-10 ">
              <label for="descripcionPartida">Descripción</label>
              <textarea id="descripcionPartida" class="selecciones " name="descripcionPartida" maxlength="200" rows="4" placeholder="Ligera descripción de la partida, tipo de juego y objetivos."></textarea>
          </div>

          <div class="cajaBotonForm">
            <input class="boton" type="submit" id="btn_crearPartida" name="entrar" value="Crear">
          </div>

          <div id="cajaMensajeErrorCrearPartida" class="d-flex flex-wrap col-12 col-sm-12 text-center pl-3 pr-3">
          </div>
