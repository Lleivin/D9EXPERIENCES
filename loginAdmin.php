...
?>
    ...
    <main>
      ...
      <section class="sectionLoginAdmin" >

              <!-- -----------LOGEARSE ADMIN----------- -->

      <div class="cajaLoginAdmin" id="cajaLoginAdmin">
        
        <form id="formLoginAdmin" class="formLogin" action="" method="POST">
            <h4 class="d-flex m-auto col-12 col-sm-12">Cuenta de Administrador</h4>
            <p class="d-flex m-auto col-12 col-sm-12">*Esta entrada está reservada únicamente para la cuenta de administradores de D9Experiences</p>


          <div class="cajaformulario">
            <label for="usuarioAdmin">Correo del Administrador: </label>
            <input class="usuario" type="email" id="usuarioAdmin" name="usuarioAdmin"
                placeholder="Correo@ejemplo.com">
          </div>

          <div class="cajaformulario">
            <label for="passwordAdmin">Contraseña del Administrador: </label>
            <input class="passwordProfe usuario" type="password" id="passwordAdmin" name="passwordAdmin" placeholder="Contraseña">
          </div>
          ...
          <div class="cajaBotonForm">
            <input class="boton" type="submit" id="btn_entrar_Admin" name="entrar" value="Entrar" onclick="logearAdmin()"
                >
          </div>

          <div id="cajaMensajeErrorLogearAdmin" class="d-flex flex-wrap col-12 col-sm-12 text-center pl-3 pr-3">
          </div>
       ...
       <footer class="footer d-flex col-12">
        ...
        <div class="cajanewsLetter display-none">
